...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sync_cmd::get_pending_conflicts,
            commands::sync_cmd::get_pending_conflicts_for_doc,
            commands::sync_cmd::get_pending_conflict,
            commands::sync_cmd::resolve_conflict,
            commands::sync_cmd::check_pending_conflicts_on_startup,
