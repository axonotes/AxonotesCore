  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("publicSigningKey", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
      new ProductTypeElement("encryptedPrivateSigningKey", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
      new ProductTypeElement("encryptedPrivateBackupSigningKey", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
